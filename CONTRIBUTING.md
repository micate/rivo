...
Thank you for your interest in improving rivo.

## AI-Driven Development and Contributions

rivo is built and maintained entirely using AI coding agents.
...
- Check existing [GitHub Issues](https://github.com/micate/rivo/issues) first to avoid duplicates.
...
- Explain the motivation: what problem does this solve, why would it benefit users, and how would it fit rivo's reads-first, minimal-footprint philosophy?

## Review and Implementation Process

1. Review: Maintainers evaluate every issue against rivo's design philosophy (simplicity, single-binary distribution, minimal resource consumption, speed).
...
Thank you for helping make rivo better.
