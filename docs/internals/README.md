# rivo Internal Architecture & Design Documentation

Welcome to the internal engineering documentation for rivo, an ultra-lightweight, zero-config code reader and navigator that delegates edits to the user's coding agent, packaged as a single statically-linked binary (~9.5 MB).

This directory contains in-depth technical write-ups explaining how rivo achieves sub-millisecond startup, instantaneous file navigation, deep code intelligence, and a minimal memory footprint (~20 MB RSS) across codebases containing tens of thousands of files.
...
flowchart TD
    ...
    subgraph GoServer ["rivo Go Backend (HTTP / JSON / Gzip)"]
...
- [User Features Documentation](../features/README.md): High-level feature guides, practical workflows, and keyboard shortcuts for all rivo capabilities.
...
- [Publishing & Release Guide](../../PUBLISHING.md): Step-by-step instructions for preparing, testing, and publishing new rivo releases.
