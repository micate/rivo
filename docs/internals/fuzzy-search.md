...
This document describes the algorithms, scoring heuristics, and concurrency strategies behind rivo's ultra-fast fuzzy file finder ([`fuzzy.go`](../../fuzzy.go)).
...
rivo solves this with a Two-Pass Bounded Search Algorithm:
